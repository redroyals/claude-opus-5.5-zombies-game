...
export const FAVELA = [
  ...
  f('fv_bullwheel', 5.0, 'cable car station drive machinery, a large horizontal steel bull wheel on a heavy steel frame, electric motor and gearbox underneath, yellow safety railings, grey and yellow industrial, weathered', { tris: 4000, tex: 1024 , lod: true }),
  f('fv_transformer', 2.6, 'electrical substation power transformer, grey steel tank with rows of cooling radiator fins on the sides, three tall brown ceramic insulator bushings on top, yellow and black warning stripes on the base, rust streaks', { tris: 3500, tex: 1024 , lod: true }),
  f('fv_bar_counter', 3.2, 'small neighbourhood snack bar counter, front clad in small blue and white square tiles, stainless steel top, glass display case with pastries, three tall metal bar stools in front, worn and lived in', { tris: 4000, tex: 1024 , lod: true }),
  f('fv_fridge', 2.0, 'tall single glass-door drinks cooler fridge, white metal body, lit interior with shelves of colourful unlabeled glass bottles, chrome handle', { tris: 3000, tex: 512 , lod: true }),
  f('fv_motorbike', 2.0, 'small 125cc street motorcycle parked on its side stand, red fuel tank, worn black seat, round headlight, chrome exhaust, mud splashes', { tris: 4000, tex: 1024 , lod: true }),
  f('fv_wires', 3.0, 'dense tangled bundle of black electrical cables and wires hanging in sagging loops from a wooden crossarm, messy wire tangle with small junction boxes', { tris: 3000, tex: 512 , lod: true }),
  f('fv_goal', 3.0, 'five-a-side football goal, white painted steel tube frame with a sagging torn white net, weathered paint, standing on the ground', { tris: 3000, tex: 512 , lod: true }),
  f('fv_drums', 1.4, 'set of samba percussion drums, two large bass drums with polished metal shells and shoulder straps, a snare drum and a tambourine on the ground, colourful shells', { tris: 3000, tex: 512 , lod: true }),
  f('fv_speakers', 1.8, 'stack of big black loudspeaker cabinets for an outdoor street party sound system, an amplifier on top, cables, worn corners', { tris: 1400, tex: 512 , lod: true }),
  f('fv_costume_rack', 1.9, 'rolling metal clothes rail with colourful feathered carnival costumes and sequined fabric hanging from it, plumes and ribbons', { tris: 3000, tex: 512 , lod: true }),
  f('fv_table_chairs', 1.4, 'white plastic outdoor table with four white plastic chairs stacked beside it, weathered', { tris: 1400, tex: 512 , lod: true }),
  f('fv_water_tower', 9.0, 'tall neighbourhood water tower, a large blue cylindrical water tank on top of a concrete frame tower with four columns and cross beams, steel ladder up one side, rust and water stains', { tris: 5000, tex: 1024 , lod: true }),
...
export const ALL = [...WEAPONS, ...MACHINES, ...ZOMBIES, ...LAHORE, ...FAVELA];
