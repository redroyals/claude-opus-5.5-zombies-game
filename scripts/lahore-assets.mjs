...
export const LAHORE = [
  ...
  l('chandelier', 1.5, 'large antique crystal glass chandelier with a gilded brass frame, three tiers of candle cups and hanging crystal drops, short chain at the top'),
  l('torch_bracket', 1.0, 'wall-mounted wrought iron torch bracket holding a cloth-wrapped wooden torch, flat back plate'),
  ...
  l('armour_stand', 1.95, 'wooden display stand shaped like a headless torso wearing 19th century Indo-Persian armour: chainmail shirt with four polished steel plates, pointed steel helmet with chainmail aventail on the top post, round steel shield leaning on the base'),
  l('weapon_rack', 2.0, 'carved wooden weapon rack holding curved sabres in scabbards, long spears and two round steel shields'),
  l('chest_gold', 1.2, 'open wooden treasure chest with iron bands overflowing with gold coins, pearl strings and coloured gemstones'),
  l('strongboxes', 1.3, 'stack of three iron-bound wooden strongboxes with heavy padlocks'),
  l('pedestal', 1.4, 'white marble pedestal column with pietra dura coloured stone floral inlay, square base and capital, flat top'),
  ...
  l('cannonballs', 1.1, 'pyramid stack of black iron cannonballs on a square wooden pallet'),
  ...
  l('charpai', 2.0, 'traditional wooden rope-woven charpai cot with turned wooden legs'),
  l('matka_pots', 1.0, 'cluster of three red clay water pots on a small wooden stand, with a brass cup'),
